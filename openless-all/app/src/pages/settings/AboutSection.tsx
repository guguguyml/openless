...
const SHOW_PRODUCT_LINKS = false;
      ...
      <Card>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontSize: 17, fontWeight: 600 }}>FluxVoice</div>
      ...
      {SHOW_PRODUCT_LINKS && (
        <Card>
          ...
          <Row label={t('modal.about.source')}>
            <button style={btnGhost} onClick={() => window.open('https://fluxvoice.app', '_blank', 'noopener,noreferrer')}>
              GitHub
            </button>
          </Row>
          <Row label={t('modal.about.docs')}>
            <button style={btnGhost} onClick={() => window.open('https://fluxvoice.app/help', '_blank', 'noopener,noreferrer')}>
              {t('modal.about.docsBtn')}
            </button>
          </Row>
          <Row label={t('modal.about.feedback')}>
            <button style={btnGhost} onClick={() => window.open('https://fluxvoice.app/feedback', '_blank', 'noopener,noreferrer')}>
