...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    sync: {
      title: 'Sync',
      desc: 'Sign in to sync style packs, vocabulary, history, and related data to the official cloud account.',
      signedIn: 'Signed in',
      signedOut: 'Signed out',
      serverUrlLabel: 'Custom sync server',
      serverUrlDesc: 'The official sync service is used by default. This URL is only for development or testing; private deployment support comes later.',
      deviceNameLabel: 'Device name',
      deviceNameDesc: 'Used to distinguish this device in your account.',
      saveSettings: 'Save',
      saved: 'Sync settings saved.',
      accountLabel: 'Account',
      accountDesc: 'Sign in with an email verification code. New emails create an account automatically. The login token stays in the OS credential vault.',
      ...
      logoutSuccess: 'Signed out of sync.',
      statusTitle: 'Sync status',
      statusDesc: 'Manual sync pulls cloud changes only. Local change queueing and automatic push are wired in later steps.',
      lastSyncLabel: 'Last sync',
      lastSyncDesc: 'Last successful pull / push time.',
      never: 'Never',
      pendingLabel: 'Pending queue',
      pendingDesc: 'Local changes kept while offline or after failed sync attempts.',
      pendingCount: '{{count}} pending',
      manualSyncLabel: 'Manual sync',
      manualSyncDesc: 'Pull the latest cloud data. Disabled when signed out.',
      manualSync: 'Sync now',
      syncing: 'Syncing…',
      syncSuccess: 'Sync complete. Current cursor: {{cursor}}.',
      clearCloudLabel: 'Clear cloud data',
      clearCloudDesc: 'Clears only cloud sync data for this account. Local data stays on this device.',
      clearCloud: 'Clear cloud',
      clearing: 'Clearing…',
      clearConfirmFirst: 'Clear cloud sync data for the current account? Local data will not be deleted.',
      clearConfirmSecond: 'Confirm again: cloud data cannot be restored after clearing. Continue?',
      clearSuccess: 'Cloud sync data cleared.',
      advancedTitle: 'Advanced settings',
      advancedDesc: 'Usually no changes are needed. This version first uses the official sync service to complete the flow.',
      migrationLabel: 'Data migration',
      migrationDesc: 'Reserved for moving sync data between the official service and another server later.',
      migrationExport: 'Export',
      migrationReupload: 'Re-upload',
      migrationImport: 'Import',
      migrationComingSoon: 'Migration opens later. These buttons are disabled for now.',
    },
    shortcuts: {
