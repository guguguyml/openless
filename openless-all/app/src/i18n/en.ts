...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    sync: {
      title: 'Sync',
      desc: 'Sign in to sync style packs, vocabulary, history, and related data to your cloud account.',
      signedIn: 'Signed in',
      signedOut: 'Signed out',
      serverUrlLabel: 'Sync server URL',
      serverUrlDesc: 'OpenLess sync backend URL. Use a local or self-hosted URL for development/private deployments.',
      deviceNameLabel: 'Device name',
      deviceNameDesc: 'Used to distinguish this device in your account.',
      saveSettings: 'Save',
      saved: 'Sync settings saved.',
      accountLabel: 'Account',
      accountDesc: 'Sign in with an email verification code. The login token stays in the OS credential vault.',
