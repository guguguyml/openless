...
export const en: typeof zhCN = {
  ...
  onboarding: {
    ...
    accessibilityHint: 'After granting, you must **fully quit FluxVoice** and reopen it (a macOS TCC requirement).',
    footerHint: 'This onboarding closes automatically once both permissions are granted. If it persists, quit FluxVoice from the menu bar and relaunch.',
  },
  overview: {
    kicker: 'DASHBOARD',
  ...
  style: {
    ...
    pack: {
      ...
      runtimeTitle: 'FluxVoice Runtime Directives',
  ...
  settings: {
    ...
    sync: {
      title: 'Sync',
      desc: 'Account, status, and advanced settings.',
      deviceNameLabel: 'Device name',
      deviceNameDesc: 'Name shown for this device in sync.',
      accountLabel: 'Account sign-in',
      accountDesc: 'Sign in to the current sync account with an email code.',
      ...
      loginSuccess: 'Signed in as {{email}}.',
      syncSuccess: 'Sync complete. Cursor {{cursor}}.',
      saved: 'Saved',
      statusTitle: 'Sync status',
      statusDesc: 'Last sync time, pending queue, and actions.',
      lastSyncLabel: 'Last sync',
      lastSyncDesc: 'Latest pull or push time on this device.',
      pendingLabel: 'Pending queue',
      pendingDesc: 'Changes waiting to upload.',
      pendingCount: '{{count}} pending',
      manualSyncLabel: 'Manual sync',
      manualSyncDesc: 'Pull from cloud, then push local changes.',
      manualSync: 'Sync now',
      syncing: 'Syncing…',
      clearCloudLabel: 'Clear cloud data',
      clearCloudDesc: 'Delete all cloud sync data for this account.',
      clearCloud: 'Clear cloud',
      clearing: 'Clearing…',
      clearConfirmFirst: 'This will delete all cloud sync data. Continue?',
      clearConfirmSecond: 'This cannot be undone. Are you sure?',
      clearSuccess: 'Cloud data cleared.',
      clearLocalLabel: 'Clear local data',
      clearLocalDesc: 'Only clears this account profile on this device. Cloud data is kept.',
      ...
      serverUrlDesc: 'Blank uses the official sync service.',
      saveSettings: 'Save settings',
      migrationLabel: 'Data migration',
      migrationDesc: 'Export, re-upload, and import will appear here later.',
      migrationExport: 'Export',
      migrationReupload: 'Re-upload',
      migrationImport: 'Import',
      migrationComingSoon: 'Shown for now, not enabled yet.',
      signedIn: 'Signed in',
      ...
      never: 'Never synced',
      codeSent: 'Code sent. Expires in {{seconds}}s.',
    },
    recording: {
      ...
      startupAtBootDesc: 'Start FluxVoice automatically when you sign in.',
    ...
    providers: {
      ...
      codexOAuthNotice: 'Codex OAuth uses the local Codex login state (~/.codex/auth.json). FluxVoice does not store an API key or Base URL for this provider.',
    ...
    shortcuts: {
      ...
      openApp: 'Open FluxVoice',
      confirmHint: 'Click ✓ on the capsule',
      notSupported: 'Not yet supported',
    },
    permissions: {
      title: 'Permissions',
      descAcc: 'FluxVoice needs the following system permissions to work. After granting, fully quit and relaunch the app for changes to take effect.',
      descNoAcc: 'FluxVoice needs microphone access and uses the global hotkey listener state to verify the native hook is running.',
      micLabel: 'Microphone',
      micDesc: 'Used to capture your voice input.',
      ...
      windowsImeDesc: 'Temporarily switches to the FluxVoice TSF IME during voice sessions to avoid clipboard insertion limits.',
      windowsImeInstalled: 'Installed',
      windowsImeUnavailable: 'Unavailable',
      windowsIme: {
        installed: 'Installed. Voice input temporarily switches to the FluxVoice IME.',
        notInstalled: 'Not installed. FluxVoice is using the clipboard/WM_PASTE fallback.',
        registrationBroken: 'Registration is broken. Reinstall the FluxVoice IME.',
    ...
    about: {
      ...
      updateDialog: {
        available: {
          ...
          desc: 'FluxVoice {{version}} is available. Update now?',
        },
        downloading: {
          title: 'Downloading update',
          desc: 'Downloading FluxVoice {{version}}. Keep the app open.',
        },
        downloaded: {
          title: 'Update ready',
          desc: 'FluxVoice {{version}} has been installed. Restart automatically now to apply it?',
        },
        installing: {
          title: 'Installing update',
          desc: 'Installing FluxVoice {{version}}. Keep the app open.',
        },
        install: 'Update now',
