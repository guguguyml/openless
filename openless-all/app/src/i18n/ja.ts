...
export const ja: typeof zhCN = {
  ...
  settings: {
    ...
    sync: {
      title: '同期',
      desc: 'サインインすると、スタイルパック、語彙、履歴などのデータを公式クラウドアカウントへ同期できます。',
      signedIn: 'サインイン済み',
      signedOut: '未サインイン',
      serverUrlLabel: 'カスタム同期サーバー',
      serverUrlDesc: '既定では公式同期サービスを使います。この URL は開発またはテスト用で、プライベートデプロイ対応は後続で開放します。',
      deviceNameLabel: 'デバイス名',
      deviceNameDesc: 'アカウント内でこのデバイスを識別するために使います。',
      saveSettings: '保存',
      saved: '同期設定を保存しました。',
      accountLabel: 'アカウント',
      accountDesc: 'メール認証コードでサインインします。新しいメールは自動でアカウントを作成します。ログイントークンは OS の認証情報ストアにのみ保存されます。',
      codePlaceholder: 'コード',
      sendCode: 'コードを送信',
      sendingCode: '送信中…',
      login: 'サインイン',
      ...
      logout: 'サインアウト',
      loggingOut: 'サインアウト中…',
      codeSent: 'コードを送信しました。{{seconds}} 秒以内に有効です。',
      loginSuccess: '{{email}} としてサインインしました。',
      logoutSuccess: '同期アカウントからサインアウトしました。',
      statusTitle: '同期状態',
      statusDesc: '手動同期はクラウド変更の取得のみ行います。ローカル変更のキュー投入と自動 push は後続ステップで接続します。',
      lastSyncLabel: '最終同期',
      lastSyncDesc: '最後に pull / push が成功した時刻。',
      never: '未同期',
      pendingLabel: '保留キュー',
      pendingDesc: 'オフライン時や同期失敗時に保持されるローカル変更数。',
      pendingCount: '{{count}} 件',
      manualSyncLabel: '手動同期',
      manualSyncDesc: 'クラウドの最新データを取得します。未サインイン時は利用できません。',
      manualSync: '今すぐ同期',
      syncing: '同期中…',
      syncSuccess: '同期完了。現在の cursor：{{cursor}}。',
      clearCloudLabel: 'クラウドデータを消去',
      clearCloudDesc: 'このアカウントのクラウド同期データのみ消去します。ローカルデータは残ります。',
      clearCloud: 'クラウドを消去',
      clearing: '消去中…',
      clearConfirmFirst: '現在のアカウントのクラウド同期データを消去しますか？ローカルデータは削除されません。',
      clearConfirmSecond: '再確認：クラウドデータは消去後に復元できません。続行しますか？',
      clearSuccess: 'クラウド同期データを消去しました。',
      advancedTitle: '詳細設定',
      advancedDesc: '通常は変更不要です。現行バージョンではまず公式同期サービスでフローを通します。',
      migrationLabel: 'データ移行',
      migrationDesc: '将来、公式サービスと別サーバー間で同期データを移行するための領域です。',
      migrationExport: 'エクスポート',
      migrationReupload: '再アップロード',
      migrationImport: 'インポート',
      migrationComingSoon: '移行機能は後続で開放します。現在これらのボタンは使用できません。',
    },
    shortcuts: {
      title: 'ショートカット一覧',
