...
export const ja: typeof zhCN = {
  ...
  settings: {
    ...
    sync: {
      title: '同期',
      desc: 'サインインすると、スタイルパック、語彙、履歴などのデータをクラウドアカウントへ同期できます。',
      signedIn: 'サインイン済み',
      signedOut: '未サインイン',
      serverUrlLabel: '同期サーバー URL',
      serverUrlDesc: 'OpenLess 同期バックエンド URL。開発環境や自前ホストではローカル / セルフホスト URL に変更できます。',
      deviceNameLabel: 'デバイス名',
      deviceNameDesc: 'アカウント内でこのデバイスを識別するために使います。',
      saveSettings: '保存',
      saved: '同期設定を保存しました。',
      accountLabel: 'アカウント',
      accountDesc: 'メール認証コードでサインインします。ログイントークンは OS の認証情報ストアにのみ保存されます。',
      codePlaceholder: 'コード',
      sendCode: 'コードを送信',
      sendingCode: '送信中…',
      login: 'サインイン',
