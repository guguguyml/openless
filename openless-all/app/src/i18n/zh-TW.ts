...
export const zhTW: typeof zhCN = {
  ...
  onboarding: {
    ...
    accessibilityHint: '授權後必須**完全退出 FluxVoice** 再重新打開（macOS TCC 規則）。',
    footerHint: '授權全部完成後此引導自動關閉。如果一直不消失，從菜單欄 FluxVoice → 退出，重新打開 App。',
  },
  overview: {
    kicker: 'DASHBOARD',
    title: '今日概覽',
  ...
  style: {
    ...
    pack: {
      ...
      runtimeTitle: 'FluxVoice 執行時附加指令',
  ...
  settings: {
    ...
    sync: {
      ...
      deviceNameDesc: '同步系統中顯示的本機名稱。',
      accountLabel: '帳號登入',
      accountDesc: '使用電子郵件驗證碼登入目前的同步帳號。',
      ...
      login: '登入',
      loggingIn: '登入中…',
      loginSuccess: '已使用 {{email}} 登入。',
      syncSuccess: '同步完成，cursor {{cursor}}。',
      saved: '已儲存',
      statusTitle: '同步狀態',
      statusDesc: '最近同步時間、待同步佇列與操作。',
      lastSyncLabel: '最近同步',
      lastSyncDesc: '本機最近一次拉取或推送的時間。',
      pendingLabel: '待同步佇列',
      pendingDesc: '等待上傳的變更。',
      pendingCount: '{{count}} 筆待同步',
      manualSyncLabel: '手動同步',
      manualSyncDesc: '先從雲端拉取，再推送本機變更。',
      manualSync: '立即同步',
      syncing: '同步中…',
      clearCloudLabel: '清空雲端資料',
      clearCloudDesc: '刪除目前帳號的所有雲端同步資料。',
      clearCloud: '清空雲端',
      clearing: '清空中…',
      clearConfirmFirst: '這會刪除雲端所有同步資料，繼續嗎？',
      clearConfirmSecond: '這一步無法復原，確定要繼續嗎？',
      clearSuccess: '已清空雲端資料。',
      clearLocalLabel: '清空本機資料',
      clearLocalDesc: '只清空目前帳號檔案在本機的資料，雲端資料會保留。',
      clearLocal: '清空本機',
      ...
      serverUrlDesc: '留空時使用官方同步服務。',
      saveSettings: '儲存設定',
      migrationLabel: '資料遷移',
      migrationDesc: '之後會在這裡提供匯出、重新上傳與匯入。',
      migrationExport: '匯出',
      migrationReupload: '重新上傳',
      migrationImport: '匯入',
      migrationComingSoon: '目前僅顯示，尚未開放。',
      signedIn: '已登入',
      signedOut: '未登入',
      logout: '登出',
      loggingOut: '登出中…',
    ...
    recording: {
      ...
      startupAtBoot: '開機自啓',
      startupAtBootDesc: '登錄系統時自動啓動 FluxVoice。',
    ...
    providers: {
      ...
      codexOAuthNotice: 'Codex OAuth 使用本機 Codex 登入狀態（~/.codex/auth.json），無需在 FluxVoice 中保存 API Key 或 Base URL。',
    ...
    shortcuts: {
      ...
      confirm: '膠囊確認插入',
      switchStyle: '切換上一次風格',
      openApp: '打開 FluxVoice',
      confirmHint: '點擊右側 ✓',
      notSupported: '暫未支持',
    },
    permissions: {
      title: '權限',
      descAcc: 'FluxVoice 需要以下系統權限才能正常工作。授權後通常需要完全退出 App 重啓一次才生效。',
      descNoAcc: 'FluxVoice 需要麥克風可用，並依賴全局快捷鍵監聽狀態判斷 native hook 是否正常工作。',
      micLabel: '麥克風',
      micDesc: '用於捕獲你的語音輸入。',
      accLabel: '輔助功能',
      ...
      windowsImeDesc: '用於在語音會話期間臨時切換到 FluxVoice TSF 輸入法，避免剪貼板插入限制。',
      windowsImeInstalled: '已安裝',
      windowsImeUnavailable: '不可用',
      windowsIme: {
        installed: '已安裝。語音輸入時會臨時切換到 FluxVoice 輸入法。',
        notInstalled: '未安裝。FluxVoice 正在使用剪貼板 / WM_PASTE 兜底。',
        registrationBroken: '註冊已損壞。請重新安裝 FluxVoice 輸入法。',
    ...
    about: {
      ...
      updateDialog: {
        available: {
          title: '發現新版本',
          desc: '發現 FluxVoice {{version}}，是否現在更新？',
        },
        downloading: {
          title: '正在下載更新',
          desc: '正在下載 FluxVoice {{version}}，請保持應用打開。',
        },
        downloaded: {
          title: '更新已準備好',
          desc: 'FluxVoice {{version}} 已安裝完成。是否現在自動重啓以應用更新？',
        },
        installing: {
          title: '正在安裝更新',
          desc: '正在安裝 FluxVoice {{version}}，請保持應用打開。',
        },
        install: '現在更新',
