...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    ...
    sync: {
      title: '同步',
      desc: '登入後可把風格包、詞彙表和歷史等資料同步到官方雲端帳號。',
      signedIn: '已登入',
      signedOut: '未登入',
      serverUrlLabel: '自訂同步伺服器',
      serverUrlDesc: '預設使用官方同步服務。這個位址僅用於開發或測試，私有化部署功能後續開放。',
      deviceNameLabel: '設備名',
      deviceNameDesc: '用於在帳號中區分這台設備。',
      saveSettings: '保存',
      saved: '同步設置已保存。',
      accountLabel: '帳號',
      accountDesc: '使用電子郵件驗證碼登入；新信箱會自動建立帳號。登入 token 只保存在本機系統憑據庫。',
      codePlaceholder: '驗證碼',
      sendCode: '發送驗證碼',
      sendingCode: '發送中…',
      login: '登入',
      ...
      logout: '退出登入',
      loggingOut: '退出中…',
      codeSent: '驗證碼已發送，{{seconds}} 秒內有效。',
      loginSuccess: '已登入 {{email}}。',
      logoutSuccess: '已退出同步帳號。',
      statusTitle: '同步狀態',
      statusDesc: '手動同步只拉取雲端變更；本機變更入隊與自動推送在後續步驟接入。',
      lastSyncLabel: '最近同步',
      lastSyncDesc: '最近一次 pull / push 成功時間。',
      never: '從未同步',
      pendingLabel: '待同步佇列',
      pendingDesc: '離線或失敗時保留的本機變更數量。',
      pendingCount: '{{count}} 條',
      manualSyncLabel: '手動同步',
      manualSyncDesc: '從雲端拉取最新資料。未登入時不可用。',
      manualSync: '立即同步',
      syncing: '同步中…',
      syncSuccess: '同步完成，當前 cursor：{{cursor}}。',
      clearCloudLabel: '清空雲端資料',
      clearCloudDesc: '只清空目前帳號的雲端同步資料，不刪除本機資料。',
      clearCloud: '清空雲端',
      clearing: '清空中…',
      clearConfirmFirst: '確定清空目前帳號的雲端同步資料？本機資料不會被刪除。',
      clearConfirmSecond: '再次確認：雲端資料清空後不可恢復。繼續嗎？',
      clearSuccess: '雲端同步資料已清空。',
      advancedTitle: '進階設定',
      advancedDesc: '一般不需要修改。當前版本先使用官方同步服務跑通流程。',
      migrationLabel: '資料遷移',
      migrationDesc: '用於未來在官方服務和其他伺服器之間遷移同步資料。',
      migrationExport: '匯出',
      migrationReupload: '重新上傳',
      migrationImport: '匯入',
      migrationComingSoon: '遷移功能後續開放，目前按鈕不可用。',
    },
    shortcuts: {
      title: '快捷鍵速查',
