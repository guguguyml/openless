...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    sync: {
      title: '동기화',
      desc: '로그인하면 스타일 팩, 어휘, 기록 등의 데이터를 클라우드 계정에 동기화할 수 있습니다.',
      signedIn: '로그인됨',
      signedOut: '로그아웃됨',
      serverUrlLabel: '동기화 서버 URL',
      serverUrlDesc: 'OpenLess 동기화 백엔드 URL. 개발 또는 자체 호스팅 환경에서는 로컬 / 자체 URL 로 변경할 수 있습니다.',
      deviceNameLabel: '장치 이름',
      deviceNameDesc: '계정 안에서 이 장치를 구분하는 데 사용됩니다.',
      saveSettings: '저장',
      saved: '동기화 설정이 저장되었습니다.',
      accountLabel: '계정',
      accountDesc: '이메일 인증 코드로 로그인합니다. 로그인 토큰은 OS 자격 증명 저장소에만 저장됩니다.',
      codePlaceholder: '코드',
      sendCode: '코드 보내기',
      sendingCode: '보내는 중…',
      login: '로그인',
