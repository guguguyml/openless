...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    sync: {
      title: '동기화',
      desc: '로그인하면 스타일 팩, 어휘, 기록 등의 데이터를 공식 클라우드 계정에 동기화할 수 있습니다.',
      signedIn: '로그인됨',
      signedOut: '로그아웃됨',
      serverUrlLabel: '사용자 지정 동기화 서버',
      serverUrlDesc: '기본값은 공식 동기화 서비스입니다. 이 URL은 개발 또는 테스트용이며, 자체 배포 지원은 이후에 열립니다.',
      deviceNameLabel: '장치 이름',
      deviceNameDesc: '계정 안에서 이 장치를 구분하는 데 사용됩니다.',
      saveSettings: '저장',
      saved: '동기화 설정이 저장되었습니다.',
      accountLabel: '계정',
      accountDesc: '이메일 인증 코드로 로그인합니다. 새 이메일은 계정을 자동으로 만듭니다. 로그인 토큰은 OS 자격 증명 저장소에만 저장됩니다.',
      codePlaceholder: '코드',
      sendCode: '코드 보내기',
      sendingCode: '보내는 중…',
      login: '로그인',
      ...
      logout: '로그아웃',
      loggingOut: '로그아웃 중…',
      codeSent: '코드를 보냈습니다. {{seconds}}초 동안 유효합니다.',
      loginSuccess: '{{email}} 계정으로 로그인했습니다.',
      logoutSuccess: '동기화 계정에서 로그아웃했습니다.',
      statusTitle: '동기화 상태',
      statusDesc: '수동 동기화는 클라우드 변경 사항만 가져옵니다. 로컬 변경 큐와 자동 push 는 이후 단계에서 연결됩니다.',
      lastSyncLabel: '최근 동기화',
      lastSyncDesc: '마지막 pull / push 성공 시간.',
      never: '동기화한 적 없음',
      pendingLabel: '대기 큐',
      pendingDesc: '오프라인 또는 실패 시 보관되는 로컬 변경 수.',
      pendingCount: '{{count}}개',
      manualSyncLabel: '수동 동기화',
      manualSyncDesc: '클라우드의 최신 데이터를 가져옵니다. 로그아웃 상태에서는 사용할 수 없습니다.',
      manualSync: '지금 동기화',
      syncing: '동기화 중…',
      syncSuccess: '동기화 완료. 현재 cursor: {{cursor}}.',
      clearCloudLabel: '클라우드 데이터 지우기',
      clearCloudDesc: '현재 계정의 클라우드 동기화 데이터만 지웁니다. 로컬 데이터는 유지됩니다.',
      clearCloud: '클라우드 지우기',
      clearing: '지우는 중…',
      clearConfirmFirst: '현재 계정의 클라우드 동기화 데이터를 지울까요? 로컬 데이터는 삭제되지 않습니다.',
      clearConfirmSecond: '다시 확인: 클라우드 데이터는 지운 뒤 복구할 수 없습니다. 계속할까요?',
      clearSuccess: '클라우드 동기화 데이터를 지웠습니다.',
      advancedTitle: '고급 설정',
      advancedDesc: '일반적으로 바꿀 필요가 없습니다. 현재 버전은 먼저 공식 동기화 서비스로 흐름을 완성합니다.',
      migrationLabel: '데이터 이전',
      migrationDesc: '나중에 공식 서비스와 다른 서버 사이에서 동기화 데이터를 옮기기 위한 영역입니다.',
      migrationExport: '내보내기',
      migrationReupload: '다시 업로드',
      migrationImport: '가져오기',
      migrationComingSoon: '이전 기능은 이후에 열립니다. 지금은 버튼을 사용할 수 없습니다.',
    },
    shortcuts: {
      title: '단축키 한눈에 보기',
