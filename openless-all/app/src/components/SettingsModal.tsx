...
import { GeneralTab, ServicesTab, SyncTab, PrivacyTab, AdvancedTab } from '../pages/settings/tabs';
...
const HELP_URL = 'https://fluxvoice.app/help';
const RELEASE_NOTES_URL = 'https://fluxvoice.app/releases';
